...
class TestAirline:
    def test_add_airline(
        ...
        response = client.post(url=f"{airline_api}/{document_id}", json=airline_data)
    ...
    def test_add_airline_without_required_fields(
        ...
        assert validation_error["loc"] == ["body", "name"]
    ...
    def test_read_airline(
        ...
        response = client.get(url=f"{airline_api}/{document_id}")
        assert response.status_code == 200
        response_data = response.json()
        print(response_data, airline_data)
    ...
    def test_delete_airline(
        ...
        response = client.delete(url=f"{airline_api}/{document_id}")
    ...
    def test_list_airlines(self, airline_api):
        ...
        response = client.get(url=f"{airline_api}/list")
        assert response.status_code == 200
        response_data = response.json()
        # Default page size
    ...
    def test_list_airlines_in_country(self, airline_api):
        ...
        response = client.get(url=f"{airline_api}/list?country={country}")
        assert response.status_code == 200
        response_data = response.json()
    ...
    def test_list_airlines_in_invalid_country(self, airline_api):
        ...
        response = client.get(url=f"{airline_api}/list?country=invalid")
        assert response.status_code == 200
        response_data = response.json()
    ...
    def test_to_airport_connections(self, couchbase_client, airline_api):
        ...
        response = client.get(url=f"{airline_api}/to-airport?airport={airport}")
        assert response.status_code == 200
